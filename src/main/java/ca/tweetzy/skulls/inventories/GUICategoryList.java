...
public class GUICategoryList extends Gui {
    ...
    private void draw() {
        ...
        setPrevPage(5, 3, new TItemBuilder(Settings.GUI_BACK_BTN_ITEM.getMaterial().parseMaterial()).setName(Settings.GUI_BACK_BTN_NAME.getString()).setLore(Settings.GUI_BACK_BTN_LORE.getStringList()).toItemStack());
        setButton(5, 4, new TItemBuilder(Settings.GUI_CLOSE_BTN_ITEM.getMaterial().parseMaterial()).setName(Settings.GUI_CLOSE_BTN_NAME.getString()).setLore(Settings.GUI_CLOSE_BTN_LORE.getStringList()).toItemStack(), e -> e.manager.showGUI(e.player, new GUIMain()));
        setNextPage(5, 5, new TItemBuilder(Settings.GUI_NEXT_BTN_ITEM.getMaterial().parseMaterial()).setName(Settings.GUI_NEXT_BTN_NAME.getString()).setLore(Settings.GUI_NEXT_BTN_LORE.getStringList()).toItemStack());
        setOnPage(e -> draw());
