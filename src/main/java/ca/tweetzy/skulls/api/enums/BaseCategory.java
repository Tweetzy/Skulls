...
public enum BaseCategory {
	...
	HELMETS("helmets", TranslationManager.string(Translations.HELMETS), Settings.DEFAULT_PRICES_HELMETS.getDouble(), 125194, Settings.GUI_MAIN_ITEMS_HELMETS_SLOT.getInt(), Settings.CATEGORIES_HELMETS_ENABLED.getBoolean()),
